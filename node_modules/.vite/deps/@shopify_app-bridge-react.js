...
var require_Error = __commonJS({
  "../node_modules/@shopify/app-bridge-core/actions/Error/index.js"(exports) {
    ...
    var AppBridgeError = (
      /** @class */
      function(_super) {
        __extends(AppBridgeError2, _super);
        function AppBridgeError2(message) {
          var _this = _super.call(this, message) || this;
          _this.name = "AppBridgeError";
          _this.message = message;
          Object.setPrototypeOf(_this, AppBridgeError2.prototype);
...
var require_Button = __commonJS({
  "../node_modules/@shopify/app-bridge-core/actions/Button/index.js"(exports) {
    ...
    function clickButton(group, component, payload) {
      ...
      return (0, helper_1.actionWrapper)({ type: action, group, payload: buttonPayload });
    }
    ...
    var Modal = (
      ...
      function(_super) {
        ...
        Modal2.prototype.setFooterPrimaryButton = function(newOptions, updateCb) {
          ...
          this.footerPrimary = this.footerPrimaryOptions ? (0, buttonHelper_1.getSingleButton)(this, this.footerPrimaryOptions, subgroups, function(newPayload) {
...
var require_validator = __commonJS({
  "../node_modules/@shopify/app-bridge-core/actions/validator.js"(exports) {
    ...
    function isAppMessage(event) {
      ...
      var data = event.data;
      return Object.prototype.hasOwnProperty.call(data, "type") && (0, helper_1.findMatchInEnum)(types_1.MessageType, data.type) !== void 0;
    }
    ...
    function fromWindow(contentWindow, localOrigin) {
      ...
      if (typeof window !== void 0) {
        window.addEventListener("message", function(event) {
          if (window === contentWindow && !env_1.isUnframed || event.source !== contentWindow || !((0, validator_1.isAppBridgeAction)(event.data.payload) || (0, validator_1.isAppMessage)(event))) {
            return;
          }
...
var require_modal = __commonJS({
  "../node_modules/@shopify/app-bridge/utilities/modal.js"(exports) {
    ...
    function createAutoSizeStylesheet() {
      ...
      autoSizeStylesheet2.innerHTML = ".".concat(AUTO_SIZE_CLASS, " { overflow: hidden; height: auto; min-height: auto; }");
    ...
    function createMutationObserver(app, id) {
      ...
      function updateHeight() {
        ...
        if (height !== lastKnownWindowHeight) {
          ...
          app.dispatch((0, Modal_1.updateModalSize)({ id, height: String(height) }));
        }
      }
...
var require_Cart = __commonJS({
  "../node_modules/@shopify/app-bridge-core/actions/Cart/index.js"(exports) {
    ...
    (function(Action2) {
      ...
      Action2["SET_CODE_DISCOUNT"] = "APP::CART::SET_CODE_DISCOUNT";
      Action2["REMOVE_DISCOUNT"] = "APP::CART::REMOVE_DISCOUNT";
      Action2["REMOVE_ALL_DISCOUNTS"] = "APP::CART::REMOVE_ALL_DISCOUNTS";
...
var require_Cart2 = __commonJS({
  "../node_modules/@shopify/app-bridge/actions/Cart/index.js"(exports) {
    ...
    Object.defineProperty(exports, "setCodeDiscount", { enumerable: true, get: function() {
      return Cart_1.setCodeDiscount;
    } });
      ...
      return function(uri_1) {
        ...
        return __awaiter(_this, __spreadArray([uri_1], args_1, true), void 0, function(uri, options) {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                return [4, (0, session_token_1.getSessionToken)(app)];
              case 1:
          ...
          return __generator(this, function(_b2) {
            switch (_b2.label) {
              ...
              case 1:
                ...
                return [4, (0, authorization_code_1.getAuthorizationCodePayload)(app)];
              case 2:
...
var require_useFeatureRequest = __commonJS({
  "../node_modules/@shopify/app-bridge-react/hooks/useFeatureRequest/useFeatureRequest.js"(exports) {
    ...
    function useFeatureRequest(group, action) {
      ...
      (0, react_1.useEffect)(function() {
        (0, Features_1.create)(app).dispatch(Features_1.Action.REQUEST, { feature: group, action });
      }, [app, group, action]);
      (0, react_1.useEffect)(function() {
...
var require_Client3 = __commonJS({
  "../node_modules/@shopify/app-bridge/client/Client.js"(exports) {
    ...
    function redirectHandler(hostFrame, config) {
      ...
      var location2 = (0, redirect_1.getLocation)();
      if (env_1.isUnframed || !location2 || !apiKey || !host || !forceRedirect || !(0, redirect_1.shouldRedirect)(hostFrame)) {
        return false;
      }
      var url = "https://".concat(host, "/apps/").concat(apiKey).concat(location2.pathname).concat(location2.search || "");
  ...
  "../node_modules/@shopify/app-bridge-core/validate/type-validate.js"(exports) {
    ...
    function matchesEnum(types, options) {
      return function(value) {
        ...
        var message = options && options.message || "expected:".concat(values.map(function(val) {
          return "`".concat(val, "`");
        }).join(" or "));
        ...
        value.forEach(function(val, key) {
          ...
          if (objectError) {
            errors = errors.concat(objectError.map(function(error) {
              return __assign(__assign({}, error), { path: "['".concat(key, "']").concat(error.path || "") });
            }));
          }
        });
    ...
    function getErrors(obj, validator, key) {
      ...
      var path = key ? "['".concat(key, "']") : void 0;
      var error = validator(value);
      if (!error) {
        return;
      }
      return error.map(function(errorObj) {
        return __assign(__assign({}, errorObj), { path: "".concat(path || "").concat(errorObj.path || "") || void 0 });
      });
    }
    ...
    function matchesString(options) {
      return function(value) {
        return typeof value === "string" ? void 0 : constructErrors(value, "".concat(exports.TYPE_ERROR, "_string"), options);
      };
    }
    ...
    function matchesBoolean(options) {
      return function(value) {
        return typeof value === "boolean" ? void 0 : constructErrors(value, "".concat(exports.TYPE_ERROR, "_boolean"), options);
      };
    }
    exports.matchesBoolean = matchesBoolean;
    function matchesPositiveInteger(options) {
      return function(value) {
        return !Number.isInteger(value) || value < 0 ? constructErrors(value, "".concat(exports.TYPE_ERROR, "_integer"), options) : void 0;
      };
    }
      ...
      return (0, type_validate_1.matchesObject)({
        type: (0, type_validate_1.matchesEnum)(type, {
          message: function(_, val) {
            return "The action type `".concat(val, "` is invalid or unsupported");
          }
        }),
...
var require_button = __commonJS({
  "../node_modules/@shopify/app-bridge-core/validate/actions/button.js"(exports) {
    ...
    function validateAction(action) {
      var validator = (0, utils_1.createActionValidator)(Button_1.Action, action.type === Button_1.Action.UPDATE ? exports.buttonSchema : void 0, true, true);
  ...
  "../node_modules/@shopify/app-bridge-core/validate/actions/modal.js"(exports) {
    ...
    function matchesSize() {
      return function(value) {
        ...
        var message = "expected:".concat(values.map(function(val) {
          return "`".concat(val, "`");
        }).join(" or "));
...
var require_type_validate2 = __commonJS({
  "../node_modules/@shopify/app-bridge/validate/type-validate.js"(exports) {
    ...
    function matchesPositiveNumber(options) {
      return function(value) {
        return Number.isNaN(value) || !Number.isFinite(value) || value < 0 ? constructErrors(value, "".concat(type_validate_1.TYPE_ERROR, "_number"), options) : void 0;
      };
    }
...
var require_cart = __commonJS({
  "../node_modules/@shopify/app-bridge/validate/actions/cart.js"(exports) {
    ...
    function createDataValidator(data) {
      return (0, utils_1.createActionValidator)(Cart_1.Action, data ? (0, type_validate_1.matchesObject)({ data }) : void 0, true, true);
    }
    function createDataValidatorWithIndex(data) {
      ...
      if (data) {
        var dataSchema = (0, type_validate_1.matchesObject)({ data });
    ...
    function validateAction(action) {
      switch (action.type) {
        ...
        default:
          return (0, type_validate_1.validate)(action, (0, utils_1.createActionValidator)(Cart_1.Action, void 0, false, true));
      }
    }
    exports.validateAction = validateAction;
  }
      ...
      var errors = (0, type_validate_1.validate)(action, (0, type_validate_1.matchesObject)({
        group: (0, type_validate_1.matchesEnum)(types_1.Group, {
          message: function(_, value) {
            return "Unknown or unsupported action group `".concat(value, "`");
          }
        }),
...
var require_package2 = __commonJS({
  "../node_modules/@shopify/app-bridge-react/package.json"(exports, module) {
    module.exports = {
      ...
      devDependencies: {
        "@shopify/app-bridge-testing-library": "^0.0.6",
